...
HARD_TASK_CONFIG = {
    ...
    "targets": [
        {"id": 0, "priority": 5, "position": (3, 3), "dynamic": True,  "risk": 0.4},
        {"id": 1, "priority": 5, "position": (7, 7), "dynamic": True,  "risk": 0.4},
        {"id": 2, "priority": 4, "position": (1, 8), "dynamic": True,  "risk": 0.2},
        {"id": 3, "priority": 4, "position": (8, 1), "dynamic": True,  "risk": 0.2},
